...
namespace PdfiumViewer.WPFDemo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            var bitmap = pdfDoc.RenderToBitmapUsingRenderPage(page, 96, 96, new System.Drawing.Rectangle(0, 0, width, height), false);
            return BitmapHelper.ToBitmapSource(bitmap);
        }

        private BitmapSource RenderPageToFDIP(int page, int width, int height)
        {
            var bitmap = pdfDoc.RenderToBitmapUsingRenderPageBitmap(page, 96, 96, new System.Drawing.Rectangle(0, 0, width, height), false);
            return BitmapHelper.ToBitmapSource(bitmap);
        }
